  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-6">
      ...
      <div className="flex-col space-y-0">
        <h1 className="text-white pb-2 px-2">Name</h1>
        <div className="flex items-center rounded-2xl bg-[#EDEDED] px-3 p-2 active:border-b-2 active:border-blue-400">
      ...
      <button className="bg-[#F8D49D] rounded-lg p-2 px-4 mt-8" href={Login}>
        Sign Up
      </button>
